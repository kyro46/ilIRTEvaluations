...
class ilExteEvalOpenCPU_IRT_dicho_04_3PL extends ilExteEvalTest
{
	...
	public function calculateDetails()
	{
		...
		$details->columns = array (
				...
				ilExteStatColumn::_create('3PL_difficulty', $this->plugin->txt('tst_OpenCPU3PL_table_3PLDiff'),ilExteStatColumn::SORT_NUMBER),
				ilExteStatColumn::_create('3PL_disc', $this->plugin->txt('tst_OpenCPU3PL_table_3PLDisc'), ilExteStatColumn::SORT_NUMBER),
				ilExteStatColumn::_create('3PL_gues', $this->plugin->txt('tst_OpenCPU3PL_table_3PLGues'), ilExteStatColumn::SORT_NUMBER)
		);
